...
const unsigned long RSCurve::straigth_treshold = 400;
...
void RSCurve::update(){
  ...
  Serial.println("$$P-auto," + String(get_angle()) + ","+ String(get_angle_pid_output()) + "," + String(p) + "," + String(get_time_since_last_adjustment())+"," + "10" );
